# -*- coding: utf-8 -*-
"""
Created on Mon Mar 29 00:36:34 2021
...
def crossVal(r, f):
    ...
    clf   = GradientBoostingClassifier(n_estimators=nbTrees, max_depth=3, verbose=1)
    ...
    with open('gbRules.' + str(r) + '.' + str(f), 'w') as f:
         sys.stdout = f # Change the standard output to the file we created.

         for i in range(nbTrees):
         # for i in range(2):
            tree_to_code(model.estimators_[i, 0])
