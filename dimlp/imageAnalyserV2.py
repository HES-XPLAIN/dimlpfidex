...
def image_analyser():
    try:
        ...
        test_sample_data_file = image_folder + "/testSampleData.txt"
        test_sample_pred_file = image_folder + "/testSamplePred.txt"
        test_sample_class_file = image_folder + "/testSampleClass.txt"
