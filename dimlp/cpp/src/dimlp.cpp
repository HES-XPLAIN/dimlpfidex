...
Dimlp::Dimlp(float eta, float mu, float flat, float errParam,
             float accuracyParam, float deltaErrParam, int discrLevels,
             int showErrParam, int nbEpochsParam, int nbLayers, int nbNeurons[],
             char weightFile[])
    :

      BpNN(eta, mu, flat, errParam, accuracyParam, deltaErrParam, showErrParam,
           nbEpochsParam, nbLayers, nbNeurons, weightFile, netType)
...
Dimlp::Dimlp(char readFile[], int nbLayers, int nbNeurons[], int discrLevels)
    :

      BpNN(readFile, nbLayers, nbNeurons, netType)
...
Dimlp::Dimlp(char readFile[], float eta, float mu, float flat, float errParam,
             float accuracyParam, float deltaErrParam, int discrLevels,
             int showErrParam, int nbEpochsParam, int nbLayers, int nbNeurons[],
             char weightFile[])
    :
