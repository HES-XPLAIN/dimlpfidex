...
class CleanRuleStruct {
  ...
  void ComputeAcc(int indClean, StringInt *carried, int *indWrong,
                  DataSet &data, DataSet &dataClass, int *nbPat, int *correct,
                  int *wrong, float *acc);
...
public:
  ...
  CleanRuleStruct(DataSet all, DataSet train, DataSet trainClass, DataSet valid,
                  DataSet validClass, DataSet test, DataSet testClass,
                  RuleProcessing *processed, BpNN *bpNn, float *out, int nbOut);
