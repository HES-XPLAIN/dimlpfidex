...
int densCls(string command) {
  ...
  net =
      new BagDimlp(quant, nbLayers, vecNbNeurons, nbDimlpNets, weightFileSave);
...
{
    densCls("DensCls -L ../dimlp/datafiles/datanormTrain -1
../dimlp/datafiles/dataclass2Train -T ../dimlp/datafiles/datanormTest -2
../dimlp/datafiles/dataclass2Test -I 16 -H2 5 -O 2 -N 2 -W
../dimlp/datafiles/dimlpDatanormBT -R -F
../dimlp/datafiles/dimlpDatanormDensClsRul.rls -p
../dimlp/datafiles/dimlpDatanormDensClsTrain.out -t
../dimlp/datafiles/dimlpDatanormDensClsTest.out -o
../dimlp/datafiles/dimlpDatanormDensClsStats -r
../dimlp/datafiles/dimlpDatanormDensClsResult.txt");
}
*/
