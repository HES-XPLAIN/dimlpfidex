...
{
    dimlpPred("DimlpPred -T ../dimlp/datafiles/datanormTest -W
../dimlp/datafiles/dimlpDatanorm.wts -I 16 -H2 5 -O 2 -q 50 -p
../dimlp/datafiles/dimlpDatanormTest.out -r
../dimlp/datafiles/dimlpDatanormPredResult.txt");
}
*/
