...

{
  ...
  cout << "-R <rulesFile>\n"; // If you want to specify the rulesFile not being
                              // dimlp.rls
...
int dimlpRul(string command) {
  ...
  RealHyp ryp(All, &net, quant, nbIn, vecNbNeurons[1] / nbIn, nbWeightLayers);
  ...
  ryp.RuleExtraction(All, Train, TrainClass, Valid, ValidClass, Test, TestClass,
                     Attr, rulesFileost);
...
{
    dimlpRul("DimlpRul -L ../dimlp/datafiles/datanormTrain -1
../dimlp/datafiles/dataclass2Train -W ../dimlp/datafiles/dimlpDatanorm.wts -T
../dimlp/datafiles/datanormTest -2 ../dimlp/datafiles/dataclass2Test -I 16 -H2 5
-O 2 -R ../dimlp/datafiles/dimlpDatanormRul.rls -o
../dimlp/datafiles/dimlpDatanormRulStats -r
../dimlp/datafiles/dimlpDatanormRulResult.txt");
}
*/
