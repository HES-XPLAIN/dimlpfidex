...
void SaveFirstHid(DataSet &data, Dimlp *net, int nbHid, char *outfile)
...
{
    dimlpCls("DimlpCls -T ../dimlp/datafiles/datanormTest -2
../dimlp/datafiles/dataclass2Test -W ../dimlp/datafiles/dimlpDatanorm.wts -I 16
-H2 5 -O 2 -q 50 -p ../dimlp/datafiles/dimlpDatanormTest.out -o
../dimlp/datafiles/dimlpDatanormClsStats -r
../dimlp/datafiles/dimlpDatanormClsResult.txt");
}*/
