...
void RealHyp::Gr1(int var, int indPat, int startVirt, int netAns)
...
void RealHyp::Gr2(int var, int indPat, int startVirt, int netAns)
...
void RealHyp::Gl1(int var, int indPat, int startVirt, int netAns)
...
void RealHyp::Gl2(int var, int indPat, int startVirt, int netAns)
...
int RealHyp::ComputeCorrect(StringInt *listPatLeft, StringInt *listPatRight)
...
void RealHyp::RuleExtraction(DataSet &data, DataSet &train, DataSet &trainClass,
                             DataSet &valid, DataSet &validClass, DataSet &test,
                             DataSet &testClass, AttrName &attr,
                             ostream &ruleFile)

{
  ...
  CleanRuleStruct clean(data, train, trainClass, valid, validClass, test,
                        testClass, SavedRules, Bpnn, Out, NbOut);
...
RealHyp::RealHyp(DataSet &data, BpNN *nn, int nbBins, int nbIn, int multiple,
                 int nbWeightLayers)
...
RealHyp::RealHyp(VirtualHyp *globalVirt, int nbNets, float *out, int nbOut,
