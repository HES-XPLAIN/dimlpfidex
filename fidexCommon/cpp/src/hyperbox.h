...
public:
  ...
  void computeCoveredSamples(const std::vector<int> &ancienCoveredSamples, int attribut, std::vector<std::vector<double>> *trainData, int startIndex, bool mainSampleGreater, double hypValue);
