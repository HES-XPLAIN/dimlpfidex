...
bool Fidex::compute(Rule *rule, int idSample, float minFidelity) {
  ...
  while (_hyperspace->getHyperbox()->getFidelity() < minFidelity && itMax) { // While fidelity of our hyperbox is not high enough
