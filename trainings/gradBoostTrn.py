...
def get_and_check_parameters(init_args):
    ...
    parser.add_argument("--max_depth", type=lambda x: enum_type(x, "no_max_depth", int_type=dict(func=int_type, min=1)), metavar="<{no_max_depth, int [1,inf[}>", help="Maximum depth of the individual regression estimators", default=3, action=TaggableAction, tag="GB")
