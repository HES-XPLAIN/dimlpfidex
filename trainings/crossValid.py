        ...
        if not kwargs:
            ...
            # Check svm parameters
                ...
                if cache_size_var is None:
                    cache_size_var = 200
                if svm_max_iterations_var is None:
                    svm_max_iterations_var = -1
            ...
            # Check mlp parameters
                ...
                if power_t_var is None:
                    power_t_var = 0.5
                if mlp_max_iterations_var is None:
                    mlp_max_iterations_var = 200
                ...
                if mlp_momentum_var is None:
                    mlp_momentum_var = 0.9
                ...
                for ki in range(k): # K-fold, we shift each time groups by 1.
                    ...
                    # Training with svm
                        ...
                        res = svmTrn(train_data_file=folder_path_from_root + separator + "train.txt",train_class_file=folder_path_from_root + separator + "trainTarget.txt",
                                     ...
                                     weights_file = folder_path_from_root + separator + "weights.wts", stats_file = folder_path_from_root + separator + "stats.txt", nb_attributes = nb_attributes,
                                     nb_classes = nb_classes, console_file = crossval_folder_temp + separator + "consoleTemp.txt", train_pred_file = folder_path_from_root + separator + "train.out",
                                     test_pred_file = folder_path_from_root + separator + "test.out", positive_class_index=positive_class_index,
                    ...
                    # Training with mlp
                        ...
                        res = mlpTrn(train_data_file=folder_path_from_root + separator + "train.txt",train_class_file=folder_path_from_root + separator + "trainTarget.txt",
                                     ...
                                     weights_file = folder_path_from_root + separator + "weights.wts", stats_file = folder_path_from_root + separator + "stats.txt", nb_attributes = nb_attributes,
                                     nb_classes = nb_classes, console_file = crossval_folder_temp + separator + "consoleTemp.txt", train_pred_file = folder_path_from_root + separator + "train.out",
                                     test_pred_file = folder_path_from_root + separator + "test.out", root_folder = root_folder, nb_quant_levels = nb_quant_levels,
                    ...
                    # Training with random forests
                        ...
                        res = randForestsTrn(train_data_file=folder_path_from_root + separator + "train.txt",train_class_file=folder_path_from_root + separator + "trainTarget.txt",
                                     ...
                                     train_pred_file = folder_path_from_root + separator + "train.out", test_pred_file = folder_path_from_root + separator + "test.out", nb_attributes = nb_attributes,
                                     nb_classes = nb_classes, rules_file = folder_path_from_root + separator + "treesRules.rls", root_folder = root_folder, n_estimators = n_estimators_var,
